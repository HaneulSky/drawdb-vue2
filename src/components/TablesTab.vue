<template>
    <div class="tables-tab-container">
        <div class="tables-tab-head">
            <!-- TODO здесь селект -->
            <input v-model="search" type="search" placeholder="Поиск" class="tables-search-input" /> 
            <button class="add-table-btn" @click="$emit('add-new-table')">Добавить таблицу</button>
        </div>
        <div v-if="tables.length" class="tables-tab-tables">
            <details 
